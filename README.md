...
🌱 Adoro codear y solucionar problemas, siempre estoy en constante aprendizaje para obtener variados conocimientos y compartirlos con el mundo, mis mayores habilidades son el trabajo en equipo, la adaptabilidad, el autoaprendizaje, la organización y las metodologías ágiles.
...
const luna = {
  ...
  interests: ["movies", "series", "videoGames", "anime", "running", "trekking", "camping"],
  preferences: ["winter", "coffee", "stars", "animals", "studioGhibli"],
  motto: "inhala, exhala",
};
```
